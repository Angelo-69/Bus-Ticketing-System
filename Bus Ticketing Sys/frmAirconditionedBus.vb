Public Class frmAirconditionedBus
    ...
    Private Sub Button50_Click(sender As Object, e As EventArgs) Handles Button50.Click
        ...
        Else
            frmPassengerInfo.busType = Label4.Text
            Me.Hide()
            frmPassengerInfo.Show()
        End If
    End Sub

    Private Sub frmAirconditionedBus_MouseMove(sender As Object, e As MouseEventArgs) Handles MyBase.MouseMove
        If seats = 0 Then
